...
FCKToolbarButtonUI.prototype.Create = function(parentElement) {
	...
	FCKTools.AddEventListenerEx(oMainElement, 'mouseover',
			FCKToolbarButtonUI_OnMouseOver, this);
	FCKTools.AddEventListenerEx(oMainElement, 'mouseout',
			FCKToolbarButtonUI_OnMouseOut, this);
	FCKTools.AddEventListenerEx(oMainElement, 'click',
			FCKToolbarButtonUI_OnClick, this);
	...
	if (this.Style == FCK_TOOLBARITEM_ONLYICON && !this.ShowArrow) {
		...
		// <td><div class="TB_Button_On" title="Smiley"><table cellpadding="0"
		// cellspacing="0"><tr><td>{Image}</td><td nowrap>Toolbar
		// Button</td><td><img
		// class="TB_Button_Padding"></td></tr></table></div></td>
		// <td><div class="TB_Button_On" title="Smiley"><table cellpadding="0"
		// cellspacing="0"><tr><td><img class="TB_Button_Padding"></td><td
		...
		if (this.ShowArrow) {
			if (this.Style != FCK_TOOLBARITEM_ONLYICON) {
				// A padding cell.
				oRow.insertCell(-1).appendChild(this
						._CreatePaddingElement(oDoc));
			}
...
FCKToolbarButtonUI.prototype.ChangeState = function(newState, force) {
	...
	// In IE it can happen when the page is reloaded that MainElement is null,
	// so exit here
	if (!e)
		return;
 ...
 * Sample outputs:
 * 
 * This is the base structure. The variation is the image that is marked as
 * {Image}: <td><div class="TB_Button_On" title="Smiley">{Image}</div></td>
 * <td><div class="TB_Button_On" title="Smiley"><table cellpadding="0"
 * cellspacing="0"><tr><td>{Image}</td><td nowrap>Toolbar Button</td><td><img
 * class="TB_Button_Padding"></td></tr></table></div></td> <td><div
 * class="TB_Button_On" title="Smiley"><table cellpadding="0" cellspacing="0"><tr><td><img
 * class="TB_Button_Padding"></td><td nowrap>Toolbar Button</td><td><img
 * class="TB_Button_Padding"></td></tr></table></div></td>
 * 
 * These are samples of possible {Image} values:
 * 
 * Strip - IE version: <div class="TB_Button_Image"><img src="strip.gif"
 * style="top:-16px"></div>
 * 
 * Strip : Firefox, Safari and Opera version <img class="TB_Button_Image"
 * style="background-position: 0px -16px;background-image: url(strip.gif);">
 * 
 * No-Strip : Browser independent: <img class="TB_Button_Image"
 * src="smiley.gif">
 */
