 ...
 * 
 * FCKXml Class: class to load and manipulate XML files. (IE specific
 * implementation)
 */
 ...
 * the element will be available as properties, as long as child element nodes,
 * but the later will generate arrays with property names prefixed with "$".
 * 
 * For example, the following XML element:
 * 
 * <SomeNode name="Test" key="2"> <MyChild id="10"> <OtherLevel name="Level 3" />
 * </MyChild> <MyChild id="25" /> <AnotherChild price="499" /> </SomeNode>
 * 
 * ... results in the following object: { name : "Test", key : "2", $MyChild : [ {
 * id : "10", $OtherLevel : { name : "Level 3" } }, { id : "25" } ],
