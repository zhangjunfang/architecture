...
function reloadDepartmentList() {
	...
	loadDiv("/restful/privilegeProxyService/department/departmentListGrid",
			params, null);
	// 部门名称
	var departmentName = $("#oceanDepartmentId").val("");
	// 部门状态
...
function _addDepartmentUI() {
	...
	$.post('/restful/privilegeProxyService/department/addDepartmentUI', null,
			function(data) {
				$.dialog({
							id : 'adddepartmentid',
							title : '添加部门',
...
function addDepartment() {
	...
	var url = "/restful/privilegeProxyService/department/addDepartment";
	$.ajax({
		url : url,
		type : "post",
		data : dataStr,
...
function _editDepartmentUI(strs) {
	$.post('/restful/privilegeProxyService/department/findDepartment', {
				"departmentid" : strs
			}, function(data) {
				$.dialog({
...
function updateDepartment() {
	...
	var dataStr = JSON.stringify(data1);
	var url = '/restful/privilegeProxyService/department/updateDepartment';
	$.ajax({
		url : url,
		type : "post",
		data : dataStr,
...
function deleteDepartmentById() {
	...
	var data = {};
	data["data"] = {};
	var url = "/restful/privilegeProxyService/department/deleteDepartment";
	var str = "";
...
function dynamicLoadDepartmentList(treeId, treeNode) {
	...
	loadDiv(
			"/restful/privilegeProxyService/department/departmentListGrid",
			params, null);
}
