...
public class CZipOutputStream extends DeflaterOutputStream implements
	...
	private static class XEntry {
		public final CZipEntry entry;
		public final long offset;
		public final int flag;

		public XEntry(CZipEntry entry, long offset) {
			this.entry = entry;
			this.offset = offset;
			this.flag = (entry.method == DEFLATED && (entry.size == -1
					|| entry.csize == -1 || entry.crc == -1))
	...
	private static int version(CZipEntry e) throws ZipException {
		switch (e.method) {
		case DEFLATED:
			return 20;
		case STORED:
