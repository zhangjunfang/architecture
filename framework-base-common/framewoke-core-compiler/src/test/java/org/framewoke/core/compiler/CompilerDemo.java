...
public class CompilerDemo {
	...
	public static void compiler1() {
		...
		int results = compiler.run(null, null, null, System.getProperty("user.dir")+"/src/test/java/org/framewoke/core/compiler/HelloWorld.java");
	...
	public static void compiler2() {
		...
		Iterable<? extends JavaFileObject> compilationUnits = fileManager
				.getJavaFileObjectsFromStrings(Arrays.asList(System.getProperty("user.dir")+"/src/test/java/org/framewoke/core/compiler/HelloWorld.java"));
