...
var setting = {
		...
		var init = {
				...
				{
					var url = "../department/departmentItemAll";
					$.ajax( {
						url : url,
						type : "post",
...
function reloadUserList(offset){
	...
	loadDiv("userListGrid",params,null);
}
...
function openDistributionUI(userId) {
	$.post('openDistributionUI', {userid:userId},function(data) {
		$.dialog( {
