...
FCKXHtmlEntities.Initialize = function() {
	...
	if (FCKConfig.ProcessHTMLEntities) {
		FCKXHtmlEntities.Entities = {
			...
			'"' : 'quot',
			// '&':'amp', // This entity is automatically handled by the XHTML
			// parser.
			// '<':'lt', // This entity is automatically handled by the XHTML
			// parser.
			// '>':'gt', // This entity is automatically handled by the XHTML
			// parser.
			'ˆ' : 'circ',
			'˜' : 'tilde',
			' ' : 'ensp',
