 ...
 * 
 * This is a generic Document Fragment object. It is not intended to provide the
 * W3C implementation, but is a way to fix the missing of a real Document
 * Fragment in IE (where document.createDocumentFragment() returns a normal
 * document instead), giving a standard interface for it. (IE Implementation)
 */
