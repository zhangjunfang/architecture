 ...
 *         &lt;element name="sectorInfo" type="{http://tempuri.org/}StringBuilder" minOccurs="0"/>
...
@XmlRootElement(name = "GetKeyForApp")
public class GetKeyForApp {
    ...
    protected StringBuilder sectorInfo;
     ...
     *     
     */
    public StringBuilder getSectorInfo() {
        return sectorInfo;
    }

    /**
     * Sets the value of the sectorInfo property.
     * 
     * @param value
     *     allowed object is
     *     {@link StringBuilder }
     *     
     */
    public void setSectorInfo(StringBuilder value) {
        this.sectorInfo = value;
    }
