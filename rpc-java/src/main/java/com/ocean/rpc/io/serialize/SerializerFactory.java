...
public final class SerializerFactory {
	...
	private final static ConcurrentHashMap<Class<?>, RpcSerializer> serializers = new ConcurrentHashMap<Class<?>, RpcSerializer>();
	...
	static {
		...
		serializers.put(java.util.Date[].class,
				DateTimeArraySerializer.instance);
		...
		serializers.put(StringBuilder[].class,
				StringBuilderArraySerializer.instance);
		serializers.put(StringBuffer[].class,
				StringBufferArraySerializer.instance);
		...
		serializers
				.put(AbstractCollection.class, CollectionSerializer.instance);
		...
		serializers.put(AtomicReference.class,
				AtomicReferenceSerializer.instance);
		serializers.put(AtomicIntegerArray.class,
				AtomicIntegerArraySerializer.instance);
		serializers.put(AtomicLongArray.class,
				AtomicLongArraySerializer.instance);
		serializers.put(AtomicReferenceArray.class,
				AtomicReferenceArraySerializer.instance);
		...
		serializers.put(DateTime.class, RpcDateTimeSerializer.instance);
		if (JdkVersion.majorJavaVersion >= JdkVersion.JAVA_18) {
			try {
				serializers.put(Class.forName("java.time.LocalDate"),
						LocalDateSerializer.instance);
				serializers.put(Class.forName("java.time.LocalTime"),
						LocalTimeSerializer.instance);
				serializers.put(Class.forName("java.time.LocalDateTime"),
						LocalDateTimeSerializer.instance);
				serializers.put(Class.forName("java.time.OffsetTime"),
						OffsetTimeSerializer.instance);
				serializers.put(Class.forName("java.time.OffsetDateTime"),
						OffsetDateTimeSerializer.instance);
				serializers.put(Class.forName("java.time.ZonedDateTime"),
						ZonedDateTimeSerializer.instance);
				serializers.put(Class.forName("java.time.Duration"),
						ToStringSerializer.instance);
				serializers.put(Class.forName("java.time.Instant"),
						ToStringSerializer.instance);
				serializers.put(Class.forName("java.time.MonthDay"),
						ToStringSerializer.instance);
				serializers.put(Class.forName("java.time.Period"),
						ToStringSerializer.instance);
				serializers.put(Class.forName("java.time.Year"),
						ToStringSerializer.instance);
				serializers.put(Class.forName("java.time.YearMonth"),
						ToStringSerializer.instance);
				serializers.put(Class.forName("java.time.ZoneId"),
						ToStringSerializer.instance);
				serializers.put(Class.forName("java.time.ZoneOffset"),
						ToStringSerializer.instance);
			} catch (Throwable e) {
			}
		}
	...
	@SuppressWarnings("rawtypes")
	public final static RpcSerializer get(Class<?> type) {
	...
	@SuppressWarnings("rawtypes")
	public final static void register(Class<?> type, RpcSerializer serializer) {
		serializers.put(type, serializer);
	}
}
