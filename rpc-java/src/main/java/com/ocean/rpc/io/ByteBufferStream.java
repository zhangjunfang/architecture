...
public final class ByteBufferStream {
	...
	final static class ByteBufferPool {
		...
		private final static int[] debruijn = new int[] { 0, 1, 28, 2, 29, 14,
				24, 3, 30, 22, 20, 15, 25, 17, 4, 8, 31, 27, 13, 23, 21, 19,
	...
	public final static ByteBufferStream wrap(byte[] array, int offset,
			int length) {
	...
	public final void readFrom(ByteChannel channel, int length)
		...
		if (n < length) {
			throw new RpcException("Unexpected EOF");
		}
	}
