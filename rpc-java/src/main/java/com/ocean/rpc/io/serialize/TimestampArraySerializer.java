...
final class TimestampArraySerializer implements RpcSerializer<Timestamp[]> {
	...
	public final static void write(OutputStream stream, WriterRefer refer,
			Timestamp[] array) throws IOException {
		if (refer != null)
			refer.set(array);
	...
	@Override
	public final void write(RpcWriter writer, Timestamp[] obj)
			throws IOException {
