...
import com.ocean.rpc.util.JdkVersion;

public final class UnserializerFactory {
	private final static ConcurrentHashMap<Class<?>, RpcUnserializer> unserializers = new ConcurrentHashMap<Class<?>, RpcUnserializer>();
	static {
		...
		unserializers.put(StringBuilder.class,
				StringBuilderUnserializer.instance);
		unserializers
				.put(StringBuffer.class, StringBufferUnserializer.instance);
		...
		unserializers.put(BigInteger[].class,
				BigIntegerArrayUnserializer.instance);
		unserializers.put(Date[].class, DateArrayUnserializer.instance);
		unserializers.put(Time[].class, TimeArrayUnserializer.instance);
		unserializers.put(Timestamp[].class,
				TimestampArrayUnserializer.instance);
		unserializers.put(java.util.Date[].class,
				DateTimeArrayUnserializer.instance);
		unserializers.put(Calendar[].class, CalendarArrayUnserializer.instance);
		unserializers.put(BigDecimal[].class,
				BigDecimalArrayUnserializer.instance);
		unserializers.put(StringBuilder[].class,
				StringBuilderArrayUnserializer.instance);
		unserializers.put(StringBuffer[].class,
				StringBufferArrayUnserializer.instance);
		...
		unserializers.put(AbstractCollection.class,
				ArrayListUnserializer.instance);
		...
		unserializers.put(AbstractSequentialList.class,
				LinkedListUnserializer.instance);
		...
		unserializers.put(AtomicBoolean.class,
				AtomicBooleanUnserializer.instance);
		unserializers.put(AtomicInteger.class,
				AtomicIntegerUnserializer.instance);
		unserializers.put(AtomicLong.class, AtomicLongUnserializer.instance);
		unserializers.put(AtomicReference.class,
				AtomicReferenceUnserializer.instance);
		unserializers.put(AtomicIntegerArray.class,
				AtomicIntegerArrayUnserializer.instance);
		unserializers.put(AtomicLongArray.class,
				AtomicLongArrayUnserializer.instance);
		unserializers.put(AtomicReferenceArray.class,
				AtomicReferenceArrayUnserializer.instance);
		...
		unserializers.put(DateTime.class, RpcDateTimeUnserializer.instance);
		if (JdkVersion.majorJavaVersion >= JdkVersion.JAVA_18) {
			try {
				unserializers.put(Class.forName("java.time.LocalDate"),
						LocalDateUnserializer.instance);
				unserializers.put(Class.forName("java.time.LocalTime"),
						LocalTimeUnserializer.instance);
				unserializers.put(Class.forName("java.time.LocalDateTime"),
						LocalDateTimeUnserializer.instance);
				unserializers.put(Class.forName("java.time.OffsetTime"),
						OffsetTimeUnserializer.instance);
				unserializers.put(Class.forName("java.time.OffsetDateTime"),
						OffsetDateTimeUnserializer.instance);
				unserializers.put(Class.forName("java.time.ZonedDateTime"),
						ZonedDateTimeUnserializer.instance);
				unserializers.put(Class.forName("java.time.Duration"),
						DurationUnserializer.instance);
				unserializers.put(Class.forName("java.time.Instant"),
						InstantUnserializer.instance);
				unserializers.put(Class.forName("java.time.MonthDay"),
						MonthDayUnserializer.instance);
				unserializers.put(Class.forName("java.time.Period"),
						PeriodUnserializer.instance);
				unserializers.put(Class.forName("java.time.Year"),
						YearUnserializer.instance);
				unserializers.put(Class.forName("java.time.YearMonth"),
						YearMonthUnserializer.instance);
				unserializers.put(Class.forName("java.time.ZoneId"),
						ZoneIdUnserializer.instance);
				unserializers.put(Class.forName("java.time.ZoneOffset"),
						ZoneOffsetUnserializer.instance);
			} catch (Throwable e) {
			}
		}
	}

	public final static RpcUnserializer get(Class<?> type) {
		RpcUnserializer unserializer = unserializers.get(type);
	...
	public final static void register(Class<?> type,
			RpcUnserializer unserializer) {
		unserializers.put(type, unserializer);
	}
