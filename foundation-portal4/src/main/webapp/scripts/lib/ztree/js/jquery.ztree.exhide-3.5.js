/*
 * JQuery zTree exHideNodes 3.5.13 http://zTree.me/
 * 
...
(function($) {
	...
	var _initNode = function(setting, level, n, parentNode, isFirstNode,
		...
		if (typeof n.isHidden == "string")
			n.isHidden = tools.eqs(n.isHidden, "true");
	...
	_view = {
		...
		makeDOMNodeMainBefore : function(html, setting, node) {
			html.push("<li ", (node.isHidden ? "style='display:none;' " : ""),
					"id='", node.tId, "' class='", consts.className.LEVEL,
	...
	data.initNode = function(setting, level, node, parentNode, isFirstNode,
		...
		if (data.tmpHideParent !== parentNode) {
			...
			var tmpPNode = (parentNode) ? parentNode : data.getRoot(setting), children = tmpPNode[setting.data.key.children];
