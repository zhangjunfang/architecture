 ...
 * 
 * Defines the FCKLanguageManager object that is used for language operations.
 */
	...
	GetActiveLanguage : function() {
		if (FCKConfig.AutoDetectLanguage) {
			...
			if (navigator.userLanguage)
				...
				// Firefox 1.0 PR has a bug: it doens't support the "language"
				// property.
			...
			// If the user's browser is set to, for example, "pt-br" but only
			// the
