 ...
 * 
 * Defines the FCKXml object that is used for XML data calls and XML processing.
 * 
 * This script is shared by almost all pages that compose the File Browser
 * frameset.
 */
	...
	if (bAsync) {
		oXmlHttp.onreadystatechange = function() {
			if (oXmlHttp.readyState == 4) {
				var oXml;
				try {
					// this is the same test for an FF2 bug as in
					// fckxml_gecko.js
				...
				if (!oXml || !oXml.firstChild
						|| oXml.firstChild.nodeName == 'parsererror') {
