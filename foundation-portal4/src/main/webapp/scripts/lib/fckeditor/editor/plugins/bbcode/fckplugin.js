...
FCK.DataProcessor = {
	 ...
	 * </html>, eventually including the DOCTYPE. @param {String} data The data
	 * to be converted in the DataProcessor specific format.
	 */
...
FCKToolbarItems.RegisterItem('Source', new FCKToolbarButton('Source', 'BBCode',
				null, FCK_TOOLBARITEM_ICONTEXT, true, true, 1));
...
// entries.
FCKConfig.ToolbarSets["Default"] = [['Source'],
		['Bold', 'Italic', 'Underline', '-', 'Link'], ['About']];
