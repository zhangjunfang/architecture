...
FCKConfig.Keystrokes = [[CTRL + 65 /* A */, true], [CTRL + 67 /* C */, true],
		...
		[CTRL + 84 /* T */, true], [CTRL + 88 /* X */, true],
		[CTRL + 86 /* V */, 'Paste'], [CTRL + 45 /* INS */, true],
...
FCKConfig.SpellerPagesServerScript = 'server-scripts/spellchecker.php'; // Available
// extension:
// .php
// .cfm
// .pl
...
FCKConfig.LinkUploadAllowedExtensions = ".(7z|aiff|asf|avi|bmp|csv|doc|fla|flv|gif|gz|gzip|jpeg|jpg|mid|mov|mp3|mp4|mpc|mpeg|mpg|ods|odt|pdf|png|ppt|pxd|qt|ram|rar|rm|rmi|rmvb|rtf|sdc|sitd|swf|sxc|sxw|tar|tgz|tif|tiff|txt|vsd|wav|wma|wmv|xls|xml|zip)$"; // empty
// for
// all
FCKConfig.LinkUploadDeniedExtensions = ""; // empty for no one

FCKConfig.ImageUpload = true;
FCKConfig.ImageUploadURL = FCKConfig.BasePath + 'filemanager/connectors/'
		+ _QuickUploadLanguage + '/upload.' + _QuickUploadExtension
		+ '?Type=Image';
...
FCKConfig.FlashUploadURL = FCKConfig.BasePath + 'filemanager/connectors/'
		+ _QuickUploadLanguage + '/upload.' + _QuickUploadExtension
		+ '?Type=Flash';
