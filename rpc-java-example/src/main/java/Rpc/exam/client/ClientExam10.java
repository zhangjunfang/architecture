...
interface ITest {
    void swapKeyAndValue(Map<String, String> strmap, RpcCallback<Map<String, String>> callback);
    @MethodName("swapKeyAndValue")
    @ByRef(true)
    void swap(Map<String, String> strmap, RpcCallback<Map<String, String>> callback);
