...
(function(g) {
	g.extend(!0, g.fn.zTree._z, {
		view : {
			...
			makeDOMNodeMainBefore : function(c, a, b) {
				c.push("<li ", b.isHidden ? "style='display:none;' " : "",
						"id='", b.tId, "' class='", l.className.LEVEL, b.level,
				...
				if (a && a.length != 0) {
					...
					for (i = 0, k = a.length; i < k; i++) {
						...
						if (!d[h.parentTId]) {
							...
							d[h.parentTId] = g === null ? e.getRoot(c) : h
									.getParentNode()
						}
						f.showNode(c, h, b)
					}
					for (var j in d)
						a = d[j][c.data.key.children], f.setFirstNodeForShow(c,
								a), f.setLastNodeForShow(c, a)
				}
			},
			...
			hideNodes : function(c, a, b) {
				if (a && a.length != 0) {
					...
					for (var j in d)
						a = d[j][c.data.key.children], f.setFirstNodeForHide(c,
								a), f.setLastNodeForHide(c, a)
				}
			},
			setFirstNode : function(c, a) {
				var b = c.data.key.children, d = a[b].length;
				d > 0 && !a[b][0].isHidden ? a[b][0].isFirstNode = !0 : d > 0
						&& f.setFirstNodeForHide(c, a[b])
			},
			setLastNode : function(c, a) {
				var b = c.data.key.children, d = a[b].length;
				d > 0 && !a[b][0].isHidden
						? a[b][d - 1].isLastNode = !0
						: d > 0 && f.setLastNodeForHide(c, a[b])
			},
			...
			setFirstNodeForShow : function(c, a) {
				var b, d, i, e, h;
				for (d = 0, i = a.length; d < i; d++)
					if (b = a[d], !e && !b.isHidden && b.isFirstNode) {
						e = b;
						break
					} else if (!e && !b.isHidden && !b.isFirstNode)
						b.isFirstNode = !0, e = b, f.setNodeLineIcos(c, b);
			...
			setLastNodeForShow : function(c, a) {
				var b, d, e, g;
				for (d = a.length - 1; d >= 0; d--)
					if (b = a[d], !e && !b.isHidden && b.isLastNode) {
						e = b;
						break
					} else if (!e && !b.isHidden && !b.isLastNode)
						b.isLastNode = !0, e = b, f.setNodeLineIcos(c, b);
			...
			initHideForExCheck : function(c, a) {
				if (a.isHidden && c.check && c.check.enable) {
					if (typeof a._nocheck == "undefined")
						a._nocheck = !!a.nocheck, a.nocheck = !0;
					a.check_Child_State = -1;
					f.repairParentChkClassWithSelf
							&& f.repairParentChkClassWithSelf(c, a)
				}
			},
			initShowForExCheck : function(c, a) {
				if (!a.isHidden && c.check && c.check.enable) {
					if (typeof a._nocheck != "undefined")
						a.nocheck = a._nocheck, delete a._nocheck;
					if (f.setChkClass) {
	...
	var g = g.fn.zTree, m = g._z.tools, l = g.consts, f = g._z.view, e = g._z.data, j = m.$;
