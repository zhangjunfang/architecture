 ...
 * 
 * FCKToolbarBreak Class: breaks the toolbars. It makes it possible to force the
 * toolbar to break to a new line. This is the IE specific implementation.
 */
...
FCKToolbarBreak.prototype.Create = function(targetElement) {
	var oBreakDiv = FCKTools.GetElementDocument(targetElement)
			.createElement('div');
