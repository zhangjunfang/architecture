...
FCKTools.AddEventListenerEx = function(sourceObject, eventName, listener,
		paramsArray) {
	// Ok... this is a closures party, but is the only way to make it clean of
	// memory leaks.
	var o = new Object();
	...
	sourceObject = null; // Memory leak cleaner (because of the above
	// closure).
...
FCKTools.AppendElement = function(target, elementName) {
	return target.appendChild(this.GetElementDocument(target)
