 ...
 * most efficient list entry check (10x faster that regex). Example: if (
 * FCKListsLib.<ListName>[key] != null )
 */
...
var FCKListsLib = {
	...
	// Elements that accept text nodes, but are not possible to edit in the
	// browser.
	NonEditableElements : {
		button : 1,
		option : 1,
