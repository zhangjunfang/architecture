/*
 * ! jQuery UI - v1.11.0pre - 2013-06-12 http://jqueryui.com Includes:
	...
	$.fn.extend({
				...
				scrollParent : function() {
					...
					return (/fixed/).test(this.css("position"))
							|| !scrollParent.length ? $(this[0].ownerDocument
...
(function($, undefined) {
	...
	$.widget("ui.draggable", $.ui.mouse, {
		...
		_convertPositionTo : function(d, pos) {
			...
			var mod = d === "absolute" ? 1 : -1, document = this.document[0], scroll = this.cssPosition === "absolute"
		...
		_generatePosition : function(event) {
			...
			var containment, co, top, left, o = this.options, document = this.document[0], scroll = this.cssPosition === "absolute"
					&& !(this.scrollParent[0] !== document && $.contains(
							this.scrollParent[0], this.offsetParent[0]))
					? this.offsetParent
	...
	$.ui.plugin.add("draggable", "scroll", {
		start : function(event, ui, i) {
			if (i.scrollParent[0] !== i.document[0]
	...
	$.ui.intersect = function(draggable, droppable, toleranceMode) {
		...
		switch (toleranceMode) {
			...
			case "pointer" :
				...
				return isOverAxis(draggableTop, t,
						droppable.proportions().height)
...
(function($, undefined) {
	...
	$.widget("ui.resizable", $.ui.mouse, {
		...
		_mouseStop : function(event) {
			...
			if (this._helper) {
				...
				soffseth = ista && hasScroll(pr[0], "left") /*
															 * TODO - jump
															 * height
															 */
						? 0
	...
	$.ui.plugin.add("resizable", "animate", {
		...
		stop : function(event) {
			var that = $(this).resizable("instance"), o = that.options, pr = that._proportionallyResizeElements, ista = pr.length
					...
					&& hasScroll(pr[0], "left") /* TODO - jump height */
					? 0
	...
	$.ui.plugin.add("resizable", "containment", {
		...
		start : function() {
			var element, p, co, ch, cw, width, height, that = $(this)
					.resizable("instance"), o = that.options, el = that.element, oc = o.containment, ce = (oc instanceof $)
					? oc.get(0)
		...
		resize : function(event) {
			var woset, hoset, isParent, isOffsetRelative, that = $(this)
					.resizable("instance"), o = that.options, co = that.containerOffset, cp = that.position, pRatio = that._aspectRatio
					|| event.shiftKey, cop = {
				top : 0,
				left : 0
	...
	$.ui.plugin.add("resizable", "alsoResize", {
		...
		start : function() {
			var that = $(this).resizable("instance"), o = that.options, _store = function(
					exp) {
				$(exp).each(function() {
							var el = $(this);
	...
	$.ui.plugin.add("resizable", "grid", {
		...
		resize : function() {
			var that = $(this).resizable("instance"), o = that.options, cs = that.size, os = that.originalSize, op = that.originalPosition, a = that.axis, grid = typeof o.grid === "number"
					? [o.grid, o.grid]
...
(function($, undefined) {
	...
	$.widget("ui.accordion", {
		...
		_setOption : function(key, value) {
			...
			if (key === "disabled") {
				this.element.toggleClass("ui-state-disabled", !!value).attr(
						"aria-disabled", value);
...
(function($, undefined) {
	...
	$.widget("ui.button", {
		...
		_destroy : function() {
			...
			this.buttonElement.removeClass(baseClasses + " ui-state-active "
