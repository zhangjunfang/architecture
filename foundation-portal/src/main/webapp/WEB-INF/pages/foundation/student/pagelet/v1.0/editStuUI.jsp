...
<link href="${ctx}/styles/css/privilege/v1.0/css/rolestyle.css"
		...
		<div class="ui-dialog">
			...
			<div class="ui-dialog-content">
				<ul>
					...
					<li class="ui-dialog-li01 cl">
					</li>
					<li class="ui-dialog-li02">
						<img id="photoimg" src="" width="100" height="80"/>
					</li> -->
			...
			<div class="ui-dialog-buttonpane">
				<div class="sub-btn-frame">
					<a class="sub-btn sub-btn-over" href="javascript:updateStu();">
						<span>保 存</span>
					</a>
				</div>
				...
				<div class="sub-btn-frame">
					<a class="sub-btn sub-btn-over" href="javascript:void(0);"> <span
						onclick="art.dialog({id:'editstuid'}).close();">取 消</span>
					</a>
				</div>
			</div>
		</div>
